...
[Usage]
$ python train.py --weights "" --cfg './models/yolov4-csp.yaml' --data './data/neu.yaml' --hyp './data/hyp.neu.yaml' --epochs 1 --batch-size 1 --img-size 320 --cache-images --device 'cpu' --logdir './result'
